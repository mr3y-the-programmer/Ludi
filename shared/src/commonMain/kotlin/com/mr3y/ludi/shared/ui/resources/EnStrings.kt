...
val EnLudiStrings = LudiStrings(
    ...
    deals_page_deal_content_description = { name, newPrice, oldPrice, savings -> "Claim %s game at %.2f bucks instead of %.2f and save %.2f percent".frmt(name, newPrice, oldPrice, savings) },
