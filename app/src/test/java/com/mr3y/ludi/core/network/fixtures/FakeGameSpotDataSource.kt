...
class FakeGameSpotDataSource : CacheResponsesDataSource<GameSpotArticle>() {

    override fun newsFeed(): List<GameSpotArticle> {
        return listOf(
            GameSpotArticle(
    ...
    override fun reviewsFeed(): List<GameSpotArticle> {
        return listOf(
            GameSpotArticle(
    ...
    override fun newReleasesFeed(): List<GameSpotArticle> {
        return listOf(
            GameSpotArticle(
                title = "logik",
                author = null,
